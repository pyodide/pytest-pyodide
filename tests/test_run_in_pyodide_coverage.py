...
from pytest_pyodide.decorator import copy_files_to_pyodide, run_in_pyodide_coverage
...
def test_run_in_pyodide_coverage(selenium, tmp_path, monkeypatch):
    ...
    pyproject_toml = pyproject_toml.format(COVERAGE_TEST_PATH=str(COVERAGE_TEST_DIR.absolute()))
    ...
    file = coverage_json["files"]["/home/hood/Documents/programming/pytest-pyodide/tests/coverage-test/dummy_pkg/__init__.py"]
